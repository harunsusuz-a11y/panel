...
import {
  ...
  SlidersHorizontal, LogOut, BookOpen, LayoutTemplate, Wrench, StickyNote, Share2, FileBarChart
} from 'lucide-react'
...
const NAV_ALL = [
  ...
  { g: 'Sistem', items: [
    ...
    { href: '/dashboard/rapor',          label: 'Günlük Rapor', Icon: FileBarChart,    roles: ['admin'] },
