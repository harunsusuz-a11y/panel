                    ...
                    {colTasks.map(t => {
                      ...
                      return (
                        <div key={t.id} onClick={() => setDetail(t)}
                          style={{ background: 'var(--s1)', border: '1px solid var(--bdr)', borderRadius: 10, padding: '12px', cursor: 'pointer', transition: 'border-color .12s' }}
      ...
      {detail && (
        <div className="overlay" onClick={e => { if (e.target === e.currentTarget) setDetail(null) }}>
          <div className="modal">
            ...
            <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--tx3)', textTransform: 'uppercase', letterSpacing: '.07em', marginBottom: 8 }}>Taşı</p>
